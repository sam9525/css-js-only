...
function animate() {
    ...
    for (let index = enemies.length - 1; index >= 0; index--) {
        ...
        for (let porjectileIndex = projectiles.length - 1; porjectileIndex >= 0; porjectileIndex--) {
            const projectile = projectiles[porjectileIndex]
            ...
            if (dist - enemy.radius - projectile.radius < 1) {
                ...
                // this is where we shirk our enemy
